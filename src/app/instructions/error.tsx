...
export default function InstructionFileError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Instruction file page error:', error)
  }, [error])
    ...
    <VStack gap={6} align="center" justify="center" minH="60vh" px={4} py={20}>
      <Box textAlign="center">
        <Heading size="xl" mb={4} color="orange.400">
          Instruction File Error
        </Heading>
        <Text fontSize="lg" color="gray.400" mb={6}>
          We encountered an error while loading the instruction file.
        </Text>
      </Box>
